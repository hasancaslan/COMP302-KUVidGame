...
public class alphaPowerUI extends AtomUI implements PropertyListener{
	...
	public alphaPowerUI(GameObject power, GamePanel panel) {
		super(IconImporter.getIconFromFileName("+alpha-b.png","powerups",new Dimension((int) (10 * L), (int) (10 * L))));
