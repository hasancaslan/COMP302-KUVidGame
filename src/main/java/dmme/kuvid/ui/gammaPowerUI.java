...
public class gammaPowerUI extends AtomUI implements PropertyListener{
	...
	public gammaPowerUI(GameObject power, GamePanel panel) {
		super(IconImporter.getIconFromFileName("+gamma-b.png","powerups",new Dimension((int) (10 * L), (int) (10 * L))));
