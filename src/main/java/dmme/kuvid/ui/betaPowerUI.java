...
public class betaPowerUI extends AtomUI implements PropertyListener{
	...
	public betaPowerUI(GameObject power, GamePanel panel) {
		super(IconImporter.getIconFromFileName("+beta-b.png","powerups",new Dimension((int) (10 * L), (int) (10 * L))));
