...
public class gammaBlockerUI extends MoleculeUI implements PropertyListener{
	...
	public gammaBlockerUI(GameObject block, GamePanel panel2) {
		super(IconImporter.getIconFromFileName("gamma-b.png","blockers",new Dimension((int) (10 * L), (int) (10 * L))));
